...
All interactivity is up to the developer. It could be a slideshow, a zoom/pan experience or an interactive canvas. Please note, G&A is looking for developer creativity. Traditional and uninventive UI/UX experiences will be judged more strictly than new and innovative ideas. Developer's are not limited to the tools and assets within this sandbox. Gallagher is looking to see how a front-end developer adapts to different code environments. It is up to the developer to provide a creative solution with a solid user experience.
